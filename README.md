...
# 3.6. Create style using REST API
...
## 7.1. Open "Visual Studio Code" and open a folder, in which you will create the application 
...
## 7.10. Stop the site and install packages
...
## 8.2. Run GraphQL Codegen in a new terminal

### 8.2.1 Create new terminal and make sure you are in correct folder
...
## 9.5. Add SimpleElementComponent
...
### 9.5.1 Create folder 'element' under 'components'
![image](https://github.com/user-attachments/assets/6b3c248a-eef7-4765-9e3e-27ceeb0e1381)

### 9.5.2 Create a new file named 'SimpleElementComponent.tsx' under 'element' folder
![image](https://github.com/user-attachments/assets/58fdadd4-9276-40be-a8f0-55ea6637f91c)

### 9.5.3 Add skeleton into SimpleElementComponent.tsx
...
### 9.5.4 Update GraphQL query in SaaS CMS or in browser
...
### 9.5.5 Add fragment to 'SimpleElementComponent.tsx'
...
### 9.5.6 Update the Html in 'SimpleElementComponent'
...
### 9.5.7 Update 'ExperienceComponent.tsx' to reference fragment
...
### 9.5.8 Update HTML to use 'SimpleElementComponent'
...
### 9.5.9 Try the application in a browser
...
### 9.5.10 Update 'element.TestProperty?.json' to 'element.TestProperty?.html'
...
### 9.5.11 Update grid in ExperienceComponent.tsx, to handle styles
